    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="relative aspect-square col-span-2">
        <Image
          src={about1}
          fill
          alt="Family sitting around a fire pit in front
           of cabin"
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Silly Paradise has been a cherished family-run
          ...
          <p>
            Over the years, we've maintained the essence of The Silly Paradise,
            blending the timeless beauty of the mountains with the personal
            touch only a family business can offer. Here, you're not just a
            guest; you're part of our extended family. So join us at The Silly
            Paradise soon, where tradition meets tranquility, and every visit is
            like coming home.
          </p>
